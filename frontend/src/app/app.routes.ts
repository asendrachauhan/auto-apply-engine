...
import { authGuard, publicGuard, onboardingGuard, adminGuard } from './core/guards/auth.guard';
...
export const routes: Routes = [
  ...
  { path: '', canActivate: [authGuard, onboardingGuard],
    ...
    { path: 'notifications', loadComponent: () => import('./features/notifications/notifications.component').then(m => m.NotificationsComponent), title: 'Notifications — AutoApply AI' },
    { path: 'referral',      loadComponent: () => import('./features/referral/referral.component').then(m => m.ReferralComponent),                title: 'Referral Program — AutoApply AI' },
    { path: 'admin', canActivate: [adminGuard],
      loadComponent: () => import('./features/admin/admin.component').then(m => m.AdminComponent), title: 'Admin — AutoApply AI' },
    { path: 'admin/users/:id', canActivate: [adminGuard],
      loadComponent: () => import('./features/admin/admin-user-detail.component').then(m => m.AdminUserDetailComponent), title: 'User Detail — AutoApply AI' },
  ]},
